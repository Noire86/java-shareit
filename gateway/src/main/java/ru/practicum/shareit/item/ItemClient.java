...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(long userId, ItemCreationDto creationDto) {
        return post("", userId, creationDto);
    }

    public ResponseEntity<Object> amendItem(long userId, long itemId, ItemDto itemCreationDto) {
    ...
    public ResponseEntity<Object> addNewComment(long userId, long itemId, CommentCreationDto commentCreationDto) {
        return post(String.format("/%d/comment", itemId), userId, commentCreationDto);
    }
