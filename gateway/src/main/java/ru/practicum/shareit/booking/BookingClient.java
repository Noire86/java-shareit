...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> create(long userId, BookingCreationDto creationDto) {
    ...
    public ResponseEntity<Object> getRequestorBookings(long userId, State state, Integer from, Integer size) {
